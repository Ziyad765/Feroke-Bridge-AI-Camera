...
# 1. Configuration
MODEL_PATH = r"c:\Users\Ziyad\Downloads\cam-export\HPC trained model\runs\detect\heavy_master_train\weights\best.pt"
...
def test_heavyweight():
    print(f"🚀 Loading HPC Heavyweight Model: {MODEL_PATH}")
    ...
    while cap.isOpened() and frame_count < max_frames:
        ...
        if frame_count % 10 == 0:
            save_path = os.path.join(OUTPUT_DIR, f"heavy_frame_{frame_count}.jpg")
    ...
    print("\n" + "="*40)
    print("📊 BENCHMARK RESULTS: HEAVY MODEL (640p)")
